...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-295269d3');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-295269d3');}
...
var brandEl=document.querySelector('.rl-brand-295269d3');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
